...
# =====================================================  LOAD MODELS ==================================================
dtc , le  = pk.load(open('D:\HealthCare_ChatBot-master\chatbot_modelsave','rb'))
model,second_le  = pk.load(open('D:\HealthCare_ChatBot-master\chatbot_model','rb'))
#ners = pk.load(open("D:\HealthCare_ChatBot-master\modeltraing_googleclob",'rb'))

# Load NN Model 
FILE = "D:\HealthCare_ChatBot-master/data.pth"
